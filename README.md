...
| Le logo n'apparaissait qu'en icône seule sur la page de connexion (pas de wordmark) | ✅ fait — sur desktop uniquement (page de connexion en carte centrée, assez large), le mot "Rohy" apparaît maintenant à côté de l'icône. Sur mobile, l'icône seule est conservée (cohérent avec le traitement des autres écrans de premier niveau) |
